...
function verifySigningChain(certificate, ca, callback) {
  ...
  /**
  * openssl has issues with validating date of CA chains thus we have to pass
  * '-no_check_time' option to it and it is OK to use since we have other methods
  * to check date validity
  */
  var params = ['verify', '-no_check_time']
  var files = []
